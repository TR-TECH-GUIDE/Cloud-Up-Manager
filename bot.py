    ...
    await cmd.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("Bots Channel", url="https://t.me/tgbotlistz")],
                [InlineKeyboardButton("Bot's Source Code", url="https://github.com/TR-TECH-GUIDE/Cloud-Up-Manager")]
            ]
        )
    )
